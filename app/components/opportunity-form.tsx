...
type Props = { id?: number; initial?: Initial; labels?: LabelMap; accounts: Option[]; projects: Option[]; owners: { id: number; firstName: string; lastName: string }[]; stages: { id: number; name: string; probability: number }[]; currencies: { code: string; name: string }[]; products: { id: number; name: string; sku: string }[] };
...
export function OpportunityForm({ id, initial, accounts, projects, owners, stages, currencies, products, labels }: Props) {
