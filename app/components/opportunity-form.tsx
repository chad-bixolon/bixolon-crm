...
export function OpportunityForm({ id, initial, accounts, owners, stages, currencies, products }: Props) {
  ...
  return <form action={action} className="panel max-w-5xl space-y-7 p-6" aria-label={id ? "Edit opportunity" : "Create opportunity"}>
    ...
    <section><h2 className="mb-3 text-lg font-semibold">Participating accounts and roles</h2>{error("participants")}
