...
type Props = { kind: 'task'|'activity'|'note'; id?: number; createKey?: string; initial?: Record<string, string | number | null>; accounts: Option[]; opportunities: Option[]; users: Option[]; activityTypes?: { code: string; name: string }[]; lockAccountId?: number; lockOpportunityId?: number };
export function WorkForm({ kind, id, createKey, initial = {}, accounts, opportunities, users, activityTypes = [], lockAccountId, lockOpportunityId }: Props) {
