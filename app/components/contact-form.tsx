...
export function ContactForm({ id, initial, accounts, accountId, leadContext, canEditMarketingPreference=false }: { id?: number; initial?: Initial; accounts: { id: number; name: string }[]; accountId?: number; leadContext?: {tradeShowId:number;leadId:number}; canEditMarketingPreference?:boolean }) {
