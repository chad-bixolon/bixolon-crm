...
import type { PipelineReportResult, AccountActivityReportResult, ProductPerformanceResult, ChannelReportResult, ReportConfiguration } from '@/lib/reporting';
