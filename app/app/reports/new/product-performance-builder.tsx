...
export async function ProductPerformanceBuilder({params,actor,saved}:{params:Params;actor:Actor;saved:Saved}){
  ...
  return <Content><PageHeader eyebrow="Reports" title={saved?'Edit Product Performance Report':'Product Performance Report'} description="Analyze product, model, and category performance across the sales pipeline." action={<Link className="btn-secondary" href="/reports">Reports</Link>}/>
