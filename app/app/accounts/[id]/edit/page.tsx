...
export default async function EditAccountPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const territories = account.territoryCategory && !options.territories.some((item) => item.code === account.territory) ? [...options.territories, { ...account.territoryCategory, active: false }] : options.territories;
