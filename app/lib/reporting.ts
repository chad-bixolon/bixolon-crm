...
function validFilterValue(filter: ReportFilter) {
  if (['ownerId','stageId','competitorId','accountId','accountOwnerId','productCategoryId','productId','skuId','projectId','minDays','opportunityId','priceExceptionId','peSalespersonId'].includes(filter.field)) return positiveInteger(filter.value);
