...
export type CatalogItem = { id: number; productId: number; productName: string; categoryId: number | null; partNumber: string; description: string | null; catalogSource?: string | null; odmSubtype?: string | null; odmCustomers?: { accountId: number; name: string }[]; odmDescription?: string | null; prices: CatalogPrice[] };
