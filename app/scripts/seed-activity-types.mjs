...
const defaults=[['CALL','Call'],['EMAIL','Email'],['MEETING','Meeting'],['DEMO','Demo'],['SITE_VISIT','Site Visit'],['QUOTE_PROPOSAL','Quote / Proposal'],['SAMPLE_EVALUATION','Sample / Evaluation'],['TECHNICAL_REVIEW','Technical Review'],['FOLLOW_UP','Follow-up'],['TRADE_SHOW','Trade Show'],['OTHER','Other']];
